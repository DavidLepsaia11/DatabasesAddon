...
namespace DatabasesAddon
{
    class Menu
    {
        public void AddMenuItems()
        {
            ...
            oCreationPackage.UniqueID = "DatabasesAddon";
            oCreationPackage.String = "DatabasesAddon";
            ...
            try
            {
                ...
                oMenuItem = Application.SBO_Application.Menus.Item("DatabasesAddon");
                oMenus = oMenuItem.SubMenus;
        ...
        public void SBO_Application_MenuEvent(ref SAPbouiCOM.MenuEvent pVal, out bool BubbleEvent)
        {
            ...
            try
            {
                if (pVal.BeforeAction && pVal.MenuUID == "DatabasesAddon.ReportForm")
                {
